\chapter{Część biometryczna - wykrywanie tęczówki oka na obrazie i~identyfikacja bądź weryfikacja tożsamości na jej podstawie}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.4]{zamkniecie.jpg}
\caption{Obraz po operacji zamknięcia}
\label{fig:zamkniecie2}
\end{center}
\end{figure}
\item Dwukrotne otwarcie, po którym usuwane są w~większej części obszary rzęs, które pozostają po wcześniejszych operacjach. Czasem po binaryzacji powstaje obraz, na którym rzęsy są połączone ze źrenicą. Ta operacja pozwala rozdzielić je od siebie.
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.4]{otwarcie2.jpg}
...
\subsection{Wykrywanie tęczówki na pobranym obrazie}
