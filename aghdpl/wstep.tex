...
Główną metodą stosowaną do porównywania kodów tęczówek jest, zaproponowane przez Daugmana, wyznaczanie odległości Hamminga. Odległość Hamminga określa ilości bitów, których wartości są różne w dwóch porównywanych kodach. Zaletą tej metody jest szybkość obliczeń oraz prostota inplementacji, dlatego została użyta w naszej pracy. Inne metody są przedstawione w pracy \cite{KoGl}.
