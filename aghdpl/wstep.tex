...
\section{Cel pracy}
\label{sec:cel}
Celem niniejszej pracy była rozbudowa biometrycznego systemu kotroli dostępu, identyfikującego lub weryfikującego tożsamość na podstawie tęczówki oka. Wśród głównych zadań znajdowała się budowa stanowiska do akwizycji obrazu tęczówki, opartego na stworzonym w pracy \cite{Gl11}, w której opisana została podstawowa wersja rozwijanego systemu. Ponadto, należało poprawić istniejący algorytm mający na celu wydzielenie obszaru tęczówki, ekstrakcję jej cech oraz utworzenie kodu biometrycznego na ich podstawie. Wymagana była również rozbudowa istniejącej bazy danych i wiążące się z tym uzupełnienie interfejsu programu nowymi funkcjami. 
